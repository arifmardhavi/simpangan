            ...
            <div class="row justify-content-center align-items-center height-self-center">
               <div class="col-md-5 col-sm-12 col-12 align-self-center">
                  <div class="sign-user_card">
                     ...
                     <?php } else if ($this->session->flashdata('danger_login')) { ?>
                        <div class="alert text-white bg-danger" role="alert">
                           <div class="iq-alert-text"><?= $this->session->flashdata('danger_login') ?></div>
                           <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                           <i class="ri-close-line"></i>
                           </button>
                        </div>
                     ...
                     <form method="post" action="<?= base_url('login/auth') ?>">
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <a href="auth-recoverpw.html" class="text-primary">Lupa Password?</a>
                           </div>
                        </div>
                        <button type="submit" class="btn btn-primary">Masuk</button>
                        <p class="mt-3">
                           Belum punya akun? <a href="<?= base_url('daftar') ?>" class="text-primary">Daftar</a>
                        </p>
                     </form>
                  </div>
               </div>
