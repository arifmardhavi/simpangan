            ...
            <div class="row justify-content-center align-items-center height-self-center">
               <div class="col-md-5 col-sm-12 col-12 align-self-center">
                  <div class="sign-user_card">
                     ...
                     <p class="cnf-mail m-auto mb-1">Email telah dikirim ke <?= $this->session->userdata('email') ?>. Silakan periksa email dari perusahaan dan klik tautan yang disertakan untuk mengatur ulang kata sandi Anda.</p>
